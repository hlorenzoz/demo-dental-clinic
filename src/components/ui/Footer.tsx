    ...
    <footer className="bg-surface-low py-32 px-8 border-t border-primary/5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-24">
        ...
        <div className="md:col-span-2">
          <h4 className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#AFCCCB] mb-8">The Practice</h4>
        ...
        <div className="md:col-span-3">
           <h4 className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#AFCCCB] mb-8">Sanctuary Access</h4>
           <ul className="space-y-4 text-sm text-[#3F4948]">
      ...
      <div className="max-w-7xl mx-auto mt-32 pt-16 flex flex-col md:flex-row justify-between items-start md:items-center text-[10px] text-[#AFCCCB] uppercase tracking-[0.3em] font-medium border-t border-primary/10">
